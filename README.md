...
Not Implemented catalog (tables, schemas, indexes), table_heap, page, Buffer Pool Manager, LRU-K Replacer, Disk Scheduler, disk manager, WAL/recovery, query optimizer, executor.
# C++
db=# \d
Tree:
- leaf (size 1)
